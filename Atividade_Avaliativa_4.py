...
def adicionar(lista):
    ...
    with open(nome_arquivo, "w") as arquivo:
            arquivo.write(f"Nome: {funcionario.nome},  Data de nascimento: {funcionario.data_nascimento}, CPF: {funcionario.cpf}, Funçao: {funcionario.funcao}\n")
    print("= Salvando os dados dos fucionarinhios=")
